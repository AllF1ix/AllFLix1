...
function updateSpotlight(data, type) {
    ...
    document.getElementById("banner-desc").innerText = data.overview || t("no_overview");
...
const translations = {
    "en": {
        ...
        "cast": "Cast:",
        "watch_now": "▶ Watch Now",
        "download_appname": "AllFLix Android App",
    ...
    "ja": {
        ...
        "cast": "出演者：",
        "watch_now": "▶ 今すぐ見る",
        "download_appname": "AllFLixアンドロイドアプリ",
        "download_badge": "近日公開",
    ...
    "ko": {
        ...
        "cast": "출연진:",
        "watch_now": "▶ 지금 시청하기",
        "download_appname": "AllFLix 안드로이드 앱",
    ...
    "es": {
        ...
        "cast": "Reparto:",
        "watch_now": "▶ Ver Ahora",
        "download_appname": "App de Android AllFLix",
    ...
    "fr": {
        ...
        "cast": "Distribution :",
        "watch_now": "▶ Regarder",
        "download_appname": "Application Android AllFLix",
    ...
    "id": {
        ...
        "download_appname": "Aplikasi Android AllFLix",
    ...
    "ar": {
        ...
        "cast": "طاقم التمثيل:",
        "watch_now": "▶ شاهد الآن",
        "download_appname": "تطبيق AllFLix لأندرويد",
    ...
    "hi": {
        ...
        "cast": "कलाकार:",
        "watch_now": "▶ अभी देखें",
        "download_appname": "AllFLix एंड्रॉइड ऐप",
    ...
    "pt": {
        ...
        "download_appname": "App Android AllFLix",
    ...
    "ru": {
        ...
        "cast": "В ролях:",
        "watch_now": "▶ Смотреть",
        "download_appname": "Android-приложение AllFLix",
    ...
    "vi": {
        ...
        "cast": "Diễn Viên:",
        "watch_now": "▶ Xem Ngay",
        "download_appname": "Ứng Dụng AllFLix Android",
    ...
    "th": {
        ...
        "cast": "นักแสดง:",
        "watch_now": "▶ ดูเลย",
        "download_appname": "แอป AllFLix สำหรับแอนดรอยด์",
    ...
    "tr": {
        ...
        "download_appname": "AllFLix Android Uygulaması",
    ...
    "pl": {
        ...
        "download_appname": "Aplikacja AllFLix na Androida",
    ...
    "fi": {
        ...
        "cast": "Näyttelijät:",
        "watch_now": "▶ Katso Nyt",
        "download_appname": "AllFLix Android-sovellus",
    ...
    "el": {
        ...
        "download_appname": "Εφαρμογή AllFLix για Android",
    ...
    "he": {
        ...
        "cast": "שחקנים:",
        "watch_now": "▶ צפה עכשיו",
        "download_appname": "אפליקציית AllFLix לאנדרואיד",
    ...
    "uk": {
        ...
        "cast": "У ролях:",
        "watch_now": "▶ Дивитися",
        "download_appname": "Android-додаток AllFLix",
    ...
    "cs": {
        ...
        "download_appname": "Aplikace AllFLix pro Android",
    ...
    "hu": {
        ...
        "download_appname": "AllFLix Android Alkalmazás",
    ...
    "ro": {
        ...
        "cast": "Distribuție:",
        "watch_now": "▶ Vezi Acum",
        "download_appname": "Aplicația AllFLix pentru Android",
    ...
    "bn": {
        ...
        "download_appname": "AllFLix অ্যান্ড্রয়েড অ্যাপ",
    ...
    "ur": {
        ...
        "download_appname": "AllFLix اینڈرائیڈ ایپ",
    ...
    "sw": {
        ...
        "download_appname": "Programu ya AllFLix ya Android",
    ...
    "fa": {
        ...
        "download_appname": "اپلیکیشن اندروید AllFLix",
    ...
    "pa": {
        ...
        "cast": "ਕਲਾਕਾਰ:",
        "watch_now": "▶ ਹੁਣੇ ਦੇਖੋ",
        "download_appname": "AllFLix ਐਂਡਰਾਇਡ ਐਪ",
    ...
    "ta": {
        ...
        "download_appname": "AllFLix ஆண்ட்ராய்டு ஆப்",
    ...
    "my": {
        ...
        "download_appname": "AllFLix အန်းဒရွိုက် အက်ပ်",
    ...
    "km": {
        ...
        "download_appname": "កម្មវិធី AllFLix សម្រាប់ Android",
...
function applyLanguage() {
    ...
    document.getElementById("label-download-appname").innerText = t("download_appname");
    document.getElementById("label-download-badge").innerText = t("download_badge");
    document.getElementById("label-download-text").innerText = t("download_text");
    const notifyLabel = document.getElementById("label-notify-me");
    if (notifyLabel) notifyLabel.innerText = t("notify_me");
...
function showDownload() {
    ...
    btn.disabled = false;
    btn.innerHTML = `<span class="notify-icon">🔔</span> <span id="label-notify-me">${t("notify_me")}</span>`;
...
// Notify Me button sa Download card
function notifyMe() {
    const btn = document.getElementById("btn-notify-me");
    btn.disabled = true;
...
const aboutUsHTML = `
    <h2 id="about-section-about">Welcome to AllFlix</h2>
    ...
    <h2 id="about-section-benefits">Benefits</h2>
    <p><strong>Truly Global</strong> — Every region, one site: Filipino, K-Drama, Turkish, European, Latin, Middle Eastern, African, anime, and more.</p>
    <p><strong>Always Up To Date</strong> — New previews added as they release.</p>
    <p><strong>Organized Browsing</strong> — Clear categories, less searching.</p>
    <p><strong>No Language Barriers</strong> — Discover storytelling beyond your own culture.</p>
    <p><strong>Free to Browse</strong> — No account required.</p>
    <p><strong>Built for Fans</strong> — Fast, clean, mobile-friendly.</p>
    ...
    <h2 id="about-section-support">Support</h2>
    <p>Questions, partnership ideas, or a copyright concern — we're listening.</p>
    <p><strong>General / Copyright:</strong> idamgo549@gmail.com</p>
    <p><strong>Response time:</strong> Within 3–5 business days.</p>
    <p><strong>Is AllFlix free to use?</strong> Yes, no account is required.</p>
    <p><strong>Do you host full movies or episodes?</strong> No — trailers only, official previews sourced from studios worldwide.</p>
    <p><strong>Can I suggest a title?</strong> Yes — just send the title, country of origin, and source of the official trailer to idamgo549@gmail.com.</p>
